...
config :cara, CaraWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CaraWeb.ErrorHTML, json: CaraWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Cara.PubSub,
  live_view: [signing_salt: "W9C8Wobt"]
...
config :cara, Cara.Mailer, adapter: Swoosh.Adapters.Local
