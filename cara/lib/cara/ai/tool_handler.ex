defmodule Cara.AI.ToolHandler do
  ...
  the context updates. Extracted from ChatLive for better testability.
  """
  ...
  ## Parameters
    ...
    - `chat_module`: Module implementing execute_tool/2 (usually Cara.AI.Chat)
  ...
  ## Examples
      ...
      iex> tool_call = ReqLLM.ToolCall.new("call_1", "calculator", %{"expression" => "2+2"})
      iex> context = ReqLLM.Context.new([])
      iex> tools = [Calculator.calculator_tool()]
      iex> ToolHandler.handle_tool_calls([tool_call], context, tools, Cara.AI.Chat)
      %ReqLLM.Context{messages: [%{role: :tool, ...}]}
  """
