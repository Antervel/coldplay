defmodule Cara.AI.Message do
  @moduledoc """
  A formal, generic message structure for AI conversations.

  This struct represents a single message in a conversation, decoupled from
  any specific domain (e.g., education). It contains the sender role, content,
  ...
  ## Examples
      ...
      iex> Cara.AI.Message.new(:user, "Hello!")
      %Cara.AI.Message{role: :user, content: "Hello", id: id, metadata: %{}}
  ...
  @doc """
  Converts a legacy message map to a `Cara.AI.Message` struct.
  """
  @spec from_map(map()) :: t()
